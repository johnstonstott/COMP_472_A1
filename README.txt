...
2. In the command line, navigate to the directory containing the main.py file. The crime_dt data files must be in the
"data" directory.
...
5. To use the program with different inputs, complete execution or exit by pressing <Ctrl + C> and then run the program
again in the same way as in step 3.
...
<The program will open the data file, compute statistics about the data, show the crime in each block in the command
line, and display the map in a new window with the threshold you provided.>
...
<The program will show the map again with the shortest path displayed in blue. When you are done viewing it, you may
close the window and the program will terminate.>
